...
INDEX_URL = '/india_topo_maps/50k/osm/osm_index.geojson';
...
function getTilePopoverContent(sheetNo, feature, statusMap) {
    ...
    if ('jpgUrl' in sheetInfo && sheetInfo['jpgUrl'] !== null) {
        html += ' ';
        html += `<a target="_blank" href=${sheetInfo['jpgUrl']}>jpg</a>`;
    }
    ...
    html += ' ';
    html += `<a target="_blank" href=/india_topo_maps/50k/osm/compare?x=${cx}&y=${cy}&z=11&r=0&l=10000111$>view</a>`;
    return html;
}
