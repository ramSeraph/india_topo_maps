...
INDEX_URL = '/india_topo_maps/25k/nhp/nhp_index.geojson';
// STATES_URL = 'https://raw.githubusercontent.com/datameet/maps/master/website/docs/data/geojson/states.geojson';

INDEX_ATTRIBUTION = makeLink("https://onlinemaps.surveyofindia.gov.in/FreeOtherMaps.aspx", "SOI NHP Index(simplified)");
...
function getTilePopoverContent(sheetNo, feature, statusMap) {
    ...
    html += ' ';
    html += `<a target="_blank" href=/india_topo_maps/25k/nhp/compare?x=${cx}&y=${cy}&z=11&r=0&l=10000111$>view</a>`;
    return html;
}
    ...
    for (let s of ['Available', 'Not Available', 'Not Parsed']) {
        legend.addItem(new ol.legend.Item({
            ...
            'feature': new ol.Feature({
                'id': s,  // Changed from 'EVEREST_SH' to 'id'
