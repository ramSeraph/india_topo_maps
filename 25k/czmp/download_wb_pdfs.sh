...
# Download WB PDFs based on grid geojson
GEOJSON_FILE="data/layers/WB_OSM_25K_Grid.geojson"
...
# Extract Map_No_1 values and download PDFs
echo "Extracting Map_No_1 values from $GEOJSON_FILE..."
map_numbers=$(jq -r '.features[] | .properties.Map_No_1' "$GEOJSON_FILE" | sort -n | uniq)
